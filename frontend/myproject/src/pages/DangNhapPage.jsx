  ...
  return (
    <main style={pageStyles}>
      <section style={cardStyles}>
        <h1 style={{ marginBottom: '0.75rem' }}>Đăng nhập</h1>
        <p style={{ marginBottom: '1.75rem', color: '#475569' }}>
          Sử dụng tài khoản Google hoặc GitHub để đăng nhập nhanh, hoặc mở giao diện đăng nhập cũ.
        </p>
        ...
        <div style={{ marginTop: '1rem', display: 'flex', gap: '0.75rem', alignItems: 'center', flexWrap: 'wrap' }}>
          <span style={{ color: '#475569' }}>Chưa có tài khoản?</span>
          <Link to="/dang-ky" style={{ color: '#2563eb', fontWeight: 600 }}>
            Đăng ký
          </Link>
        </div>
        ...
        <div style={{ marginTop: '1.75rem', padding: '1rem', borderRadius: '16px', background: '#f1f5f9' }}>
          <p style={{ marginBottom: '0.75rem' }}>
            Hoặc sử dụng biểu mẫu đăng nhập cũ để tiếp tục.
          </p>
